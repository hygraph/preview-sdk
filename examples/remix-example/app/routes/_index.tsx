...
export async function loader({}: LoaderFunctionArgs) {
  try {
    ...
    return json({ recipes: [], error: error instanceof Error ? error.message : 'Unknown error' });
  }
}
        ...
        {error && (
          <div className="mb-8 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
            ...
            <p className="text-red-500 text-xs mt-2">
              This is likely because the Hygraph endpoint is not accessible in your environment.
