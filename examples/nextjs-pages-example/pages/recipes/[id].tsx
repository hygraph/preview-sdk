    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-4">Recipe Not Found</h1>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <section className="bg-gradient-to-b from-gray-900 via-gray-800 to-transparent">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="mb-8">
            <Link href="/" className="inline-flex items-center text-gray-400 hover:text-white transition-colors duration-200 group">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        {/* Nutrition Info */}
        {recipe.nutrition && (
          <section className="mt-16 bg-gray-800/30 backdrop-blur-sm rounded-3xl p-8 ring-1 ring-white/10">
                  ...
                  case 'VideoEmbed': {
                    ...
                    return (
                      <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8 border-2 border-purple-200 shadow-lg">
                        ...
                        <div className="aspect-video bg-gray-200 rounded-xl mb-6 overflow-hidden shadow-inner" {...videoUrlAttributes}>
                          {(() => {
